...
$8e515b832afe5669$var$_renderRoundedCSSProp = function _renderRoundedCSSProp(ratio, data) {
    ...
    for(i = 0; i < props.length; i += 3){
        ...
        if (!props[i + 1]) props[i + 2] ? style[props[i]] = props[i + 2] : style.removeProperty(props[i].substr(0, 2) === "--" ? props[i] : props[i].replace($8e515b832afe5669$var$_capsExp, "-$1").toLowerCase());
...
}, $8e515b832afe5669$var$_getReparentedCloneBBox = function _getReparentedCloneBBox(target) {
    //works around issues in some browsers (like Firefox) that don't correctly report getBBox() on SVG elements inside a <defs> element and/or <mask>. We try creating an SVG, adding it to the documentElement and toss the element in there so that it's definitely part of the rendering tree, then grab the bbox and if it works, we actually swap out the original getBBox() method for our own that does these extra steps whenever getBBox is needed. This helps ensure that performance is optimal (only do all these extra steps when absolutely necessary...most elements don't need it).
    var owner = target.ownerSVGElement, svg = $8e515b832afe5669$export$a232bb0480ae674a("svg", owner && owner.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), clone = target.cloneNode(true), bbox;
    ...
    try {
        ...
        bounds = $8e515b832afe5669$var$_getReparentedCloneBBox(target);
        cloned = 1;
    }
    bounds && (bounds.width || bounds.height) || cloned || (bounds = $8e515b832afe5669$var$_getReparentedCloneBBox(target)); //some browsers (like Firefox) misreport the bounds if the element has zero width and height (it just assumes it's at x:0, y:0), thus we need to manually grab the position in that case.
...
}, $a129d6ec0733e75c$var$_addListener = function _addListener(element, type, func, passive, capture) {
...
var $a129d6ec0733e75c$export$c1cbdee04e18ea8b = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars) {
        ...
        deltaY = [
            ...
            self._vy.reset();
            $a129d6ec0733e75c$var$_addListener(isNormalizer ? target : ownerDoc, $a129d6ec0733e75c$var$_eventTypes[1], _onDrag, passive, true);
        ...
        self.enable = function(e) {
            if (!self.isEnabled) {
                ...
                type.indexOf("scroll") >= 0 && $a129d6ec0733e75c$var$_addListener(isViewport ? ownerDoc : target, "scroll", onScroll, passive, capture);
                type.indexOf("wheel") >= 0 && $a129d6ec0733e75c$var$_addListener(target, "wheel", _onWheel, passive, capture);
                if (type.indexOf("touch") >= 0 && $a129d6ec0733e75c$var$_isTouch || type.indexOf("pointer") >= 0) {
                    $a129d6ec0733e75c$var$_addListener(target, $a129d6ec0733e75c$var$_eventTypes[0], _onPress, passive, capture);
                    ...
                    allowClicks && $a129d6ec0733e75c$var$_addListener(target, "click", clickCapture, true, true);
...
$a129d6ec0733e75c$export$c1cbdee04e18ea8b.version = "3.12.7";
...
$79bd7f461221d269$var$_revertRecorded = function _revertRecorded(media) {
    ...
    $79bd7f461221d269$var$_docEl = $79bd7f461221d269$var$_doc.documentElement; // some frameworks like Astro may cache the <body> and replace it during routing, so we'll just re-record the _docEl and _body for safety (otherwise, the markers may not get added properly).
...
var $79bd7f461221d269$export$875bcbe48555930 = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars, animation) {
        ...
        if (snap) {
            ...
            snapDelayedCall = $79bd7f461221d269$var$gsap.delayedCall(snap.delay || scrubSmooth / 2 || 0.1, function() {
                ...
                if ((refreshedRecently || Math.abs(self.getVelocity()) < 10) && !tween && !$79bd7f461221d269$var$_pointerIsDown && lastSnap !== scroll) {
                    ...
                    $79bd7f461221d269$var$_isNumber(endValue) || (endValue = naturalEnd); // in case the function didn't return a number, fall back to using the naturalEnd
        ...
        self.refresh = function(soft, force, position, pinOffset) {
            ...
            if (pin && !($79bd7f461221d269$var$_clampingMax && self.end >= $79bd7f461221d269$var$_maxScroll(scroller, direction))) {
                ...
                if (pinSpacing) {
                    ...
                    i = $79bd7f461221d269$var$_getSize(pin, direction);
                    i && spacer.style.flexBasis !== "auto" && (spacer.style.flexBasis = i + $79bd7f461221d269$var$_px);
                }
                if (useFixedPosition) {
                    override = {
        ...
        self.update = function(reset, recordVelocity, forceFake) {
            ...
            if (anticipatePin && pin && !$79bd7f461221d269$var$_refreshing && !$79bd7f461221d269$var$_startup && $79bd7f461221d269$var$_lastScrollTime) {
                if (!clipped && start < scroll + (scroll - scroll2) / ($79bd7f461221d269$var$_getTime() - $79bd7f461221d269$var$_time2) * anticipatePin) clipped = 0.0001;
                else if (clipped === 1 && end > scroll + (scroll - scroll2) / ($79bd7f461221d269$var$_getTime() - $79bd7f461221d269$var$_time2) * anticipatePin) clipped = 0.9999;
            }
        ...
        if (animation && animation.add && !change) {
            ...
            self.update = function() {
                ...
                (0, $a129d6ec0733e75c$export$3cd1cee43d19b683).cache++; // otherwise a cached scroll position may get used in the refresh() in a very rare scenario, like if ScrollTriggers are created inside a DOMContentLoaded event and the queued requestAnimationFrame() fires beforehand. See https://gsap.com/community/forums/topic/41267-scrolltrigger-breaks-on-refresh-when-using-domcontentloaded/
    ...
    ScrollTrigger.enable = function enable() {
        ...
        if ($79bd7f461221d269$var$gsap) {
            ...
            $79bd7f461221d269$var$_lastScroll = $79bd7f461221d269$var$_win.pageYOffset || 0;
            ...
            if ($79bd7f461221d269$var$_body) {
                ...
                $79bd7f461221d269$var$_ignoreMobileResize = (0, $a129d6ec0733e75c$export$c1cbdee04e18ea8b).isTouch === 1;
                ...
                if ($79bd7f461221d269$var$gsap.matchMedia) {
                    ...
                    $79bd7f461221d269$var$gsap.matchMedia().add("(orientation: portrait)", function() {
                ...
                var bodyHasStyle = $79bd7f461221d269$var$_body.hasAttribute("style"), bodyStyle = $79bd7f461221d269$var$_body.style, border = bodyStyle.borderTopStyle, AnimationProto = $79bd7f461221d269$var$gsap.core.Animation.prototype, bounds, i;
                ...
                if (!bodyHasStyle) {
                    ...
                    $79bd7f461221d269$var$_body.setAttribute("style", ""); // it's not enough to just removeAttribute() - we must first set it to empty, otherwise Next.js complains.
                    $79bd7f461221d269$var$_body.removeAttribute("style");
...
$79bd7f461221d269$export$875bcbe48555930.version = "3.12.7";
...
$79bd7f461221d269$export$875bcbe48555930.refresh = function(safe) {
    return safe ? $79bd7f461221d269$var$_onResize(true) : ($79bd7f461221d269$var$_coreInitted || $79bd7f461221d269$export$875bcbe48555930.register()) && $79bd7f461221d269$var$_refreshAll(true);
};
...
$79bd7f461221d269$export$875bcbe48555930.sort = function(func) {
    if ($79bd7f461221d269$var$_isFunction(func)) return $79bd7f461221d269$var$_triggers.sort(func);
    var scroll = $79bd7f461221d269$var$_win.pageYOffset || 0;
    $79bd7f461221d269$export$875bcbe48555930.getAll().forEach(function(t) {
        return t._sortY = t.trigger ? scroll + t.trigger.getBoundingClientRect().top : t.start + $79bd7f461221d269$var$_win.innerHeight;
    });
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (input) {
        ...
        input.addEventListener("input", function() {
            if (this.value !== localStorage.getItem(storageKey)) {
                ...
                if (this.value.trim() !== "") timeout = setTimeout(()=>{
    ...
    if (singleLogo) {
        ...
        if (singleLogoUrl) singleLogo.style.backgroundImage = `url(${singleLogoUrl})`;
    }
    ...
    if (filterMobile || filterCont) filterMobile.onclick = function openFilter() {
        filterCont.classList.remove("hidden");
    };
    windowWidthChange();
    // Mouse tracker for gradient changes
    if (window.innerWidth > 768) document.addEventListener("mousemove", (event)=>{
        ...
        document.documentElement.style.setProperty("--gradientColors", `${color1} 0%, ${color2} 52%, ${color3} 100%`);
    });
    {
        ...
        (0, $3065398eb637bd52$export$99ee26438460406a).set(randomXElem, {
            translateX: ()=>Math.random() * 60 - 30
        });
        (0, $3065398eb637bd52$export$99ee26438460406a).set(randomYElem, {
        ...
        //   });
        // }
        (0, $3065398eb637bd52$export$99ee26438460406a).set(cardsScore, {
            rotate: ()=>Math.random() * 40 - 20
        });
        // alternative random placement
        const alternative = document.querySelectorAll(".single-alternative");
        if (alternative) {
            if (window.innerWidth < 768) (0, $3065398eb637bd52$export$99ee26438460406a).set(alternative, {
                translateX: ()=>Math.random() * 100 - 50,
                translateY: ()=>Math.random() * 40 - 20
            });
            else (0, $3065398eb637bd52$export$99ee26438460406a).set(alternative, {
                translateX: ()=>Math.random() * 100 - 50,
                translateY: ()=>Math.random() * 60 - 30
            });
        }
    ...
    // Main scrollTrigger
    {
        ...
        let tl = (0, $3065398eb637bd52$export$99ee26438460406a).timeline({
            scrollTrigger: {
                trigger: hero,
                start: "top top",
                end: "center top",
    ...
    // Changing background scrolltrigger
    {
        ...
        (0, $3065398eb637bd52$export$99ee26438460406a).to(footerCont, {
            scrollTrigger: {
...
//# sourceMappingURL=index.ccce9596.js.map
